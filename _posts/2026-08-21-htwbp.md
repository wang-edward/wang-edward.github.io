...
- Example: a thermometer app. Don’t store temperature in both celsius AND fahrenheit, instead pick one and derive the other:
...
- This also reduces invariants. Now you don’t have to ensure celsius is always == fahrenheit
    ...
    - What if you have 20C ⇒ 68F ⇒ 19.99999C ≠ 20C
