...
Like fundamentally the chatbot interface is collaborative.
The interaction is literally modelled like a text conversation in discord or slack or whatever.

And it’s a much tighter feedback loop between you and the AI.
Whereas in agentic coding, there isn’t a clear time where you can step in and help the ai.

Similarly the ai doesn’t really help you understand.
You have to wait till it’s done the whole thing to read it.
Which makes it harder to verify correctness, and you also wasted a lot of compute if it spent time working on a wrong spec.
