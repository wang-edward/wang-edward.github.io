...
But changing the references breaks the link between the schematic and PCB layouts. So you can't just paste the layouts.
...
Then make the hierarchal schematics 100% the same so the references line up.

Now you can copy paste the example layout in and do "Update PCB from Schematic".
